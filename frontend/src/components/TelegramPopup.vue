      ...
      <div class="popup-content-wrapper">
        ...
        <div class="popup-body">
          ...
          <div class="icon-wrapper">
            <img src="/static/four/icon2.png" alt="Telegram Icon" />
          </div>

          <!-- 标题 -->
          <h2 class="title">{{ t('socialPopup.telegramTitle') }}</h2>
...
.join-btn:disabled {
  ...
  cursor: not-allowed;
  box-shadow: 0 10px 28px rgba(245, 182, 56, 0.35);
  transform: none;
}
...
@media (max-width: 768px) {
  ...
  .popup-content-wrapper {
    height: calc(430px - 38px - 75px); /* 总高度 - 顶部图片 - 底部导航栏 */
  }
