...
// 2024-12-22 FIXED: 与 referralMath.js 保持一致的新配置
const CEX_RATES = [0.08, 0.04, 0.02, 0.005, 0.005, 0.005, 0.005, 0.005]; // 8级, 总计16.5%
const DEX_RATES = [0.02, 0.01, 0.005]; // 3级, 总计3.5%
